...
import { Lexer, type LexerOptions, Token, TokenReader, TokenType } from "../src/lexer.ts";
import { CstBuilder, Parser, ParserOptions } from "../src/parser.ts";
...
suite("test lexer", () => {
    test("test calcuration", () => {
        const lexer = new TestLexer({ skipTokenStrategy: "ignore", location: false });
